...
Revision ID: 2a36ba0aa7b6
Revises: 
Create Date: 2026-04-12 06:04:14.910122
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('drug_lookup_id', sa.Integer(), nullable=False),
    sa.Column('brand_name', sa.String(length=120), nullable=True),
    sa.Column('generic_name', sa.String(length=120), nullable=True),
    sa.Column('dosage_form', sa.String(length=50), nullable=True),
    sa.Column('quantity', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['drug_lookup_id'], ['drug_lookup.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
